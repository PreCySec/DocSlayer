                                        ...
                                        if len(m) > 200:
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    #print(m)
                                                    d0cfi11e_index = m.index(b'd0cf11e0a1b11ae1')
                                                    print("\'d0cf11e0a1b11ae1\' location in arbitrary hex data: %d" % d0cfi11e_index)
                                                    carved_ole = m[d0cfi11e_index:]
                                                    ms_ole = OLEParser(carved_ole)
                                                    ms_ole.extract_embedded_ole(f.name, f.name)
